...
<html>
    ...
    <body>
        ...
        $sql = "SELECT codped_PK, codcli_FK, codprod_FK, descr, vlped FROM pedido WHERE codped_PK = '$codped_PK' ";
        ...
        if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                echo "Código do Pedido: " . $row ["codped_PK"] . " <br> Código de Cliente: " . $row["codcli_FK"] . " <br> Código do Produto: " . $row["codprod_FK"] . " <br> Descrição: " . $row["descr"] . " <br> Valor do Pedido: " . $row["vlped"] . "<br><br>";
